...
$(document).ready(function() {
  ...
  function initPage() {
    // Run an AJAX request for any unsaved articles
  ...
  function createCard(art) {
    // This function takes in a single JSON object for an article/article
  ...
  function handleArticleSave() {
    ...
    // When we rendered the article initially, we attached a javascript object containing the article id
